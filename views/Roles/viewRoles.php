                ...
                <main>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800 mt-4">Roles</h1>
                        </div> 
                                ...
                                <div class="card shadow mb-5">
                                    ...
                                    <div class="card-body">
                                        <div class="chart-area">
                                            <form action="<?=constant('URL')?>roles/insertarRol" method="POST" id="frmRoles">
                                                <div class="row mt-4 justify-content-center">
                                                    <div class="form-group col-sm-6">
                                                        <label><b>Nombre de Rol</b></label>
                                                        <input type="text" class="form-control" name="txtRol" data-validetta="required"><br>
                                                    </div>
                                                </div>
