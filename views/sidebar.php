<div id="layoutSidenav_nav">
    <style>
        #s,.sb-sidenav-menu{background-color: #150c25;}
    </style>
        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="index.html">
                    <div class="sb-nav-link-icon"><i class="far fa-address-book fa-lg"></i></div>
                    Inicio
                </a>

                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                    <div class="sb-nav-link-icon"><i class="fas fa-user-shield fa-lg"></i></div>
                    Gestión Usuarios
                ...
                <div class="collapse" id="collapsePages3" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="s">
                        ...
                        <a class="nav-link ml-3 mb-5" href="layout-static.html"> 
                            <div class="sb-nav-link-icon"><i class="fas fa-print"></i></div>
